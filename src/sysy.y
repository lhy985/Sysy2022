...
VoidType:   VOID {$$=mknode(VOID_TYPE,NULL,NULL,NULL,yylineno);strcpy($$->type_id,$1);$$->type=VOID;}
            ;
VarDecl:      BType VarDef VarDefList SEMI {$$=mknode(VAR_DECL,$1,$2,$3,yylineno); $$->type = $1->type; }
            ;
VarDefList: {$$=NULL;}
...
FuncFParam:   BType ID Arrays {$$=mknode(FUNC_PARAM,$1,$3,NULL,yylineno);strcpy($$->type_id,$2);}
            ;
Arrays:       {$$=NULL;}
